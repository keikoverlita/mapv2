        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header">Role: <?php echo $role ?></li>
              ...
              <li>
                <a href="http://digital361.xyz/wfm" target="_blank">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 id="modal-title-user" class="modal-title">User Form</h3>
            </div>
...
function setContentPolygon(event){
  var contentString =
  '<div style="width: 300px; max-height: 300px; overflow:auto !important; line-height: 1.35;white-space: nowrap;">'+
